...
* Paid (Pagado)-   Para pagos automatizados (PayPal, Stripe, PIN, por ejemplo), el portal de pagos marcará automáticamente un pedido como 'pagado' cuando se haya procesado. \
  Los pagos no automatizados (efectivo, transferencia bancaria, etc.) también se marcarán como 'pagados' cuando se actualicen manualmente.
